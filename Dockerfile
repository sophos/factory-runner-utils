...
RUN curl -o /opt/runner-agent/runner-agent.exe https://refactrreleasesdevel.blob.core.windows.net/public/runner/runner-agent_linux-x64_1.86.2-preview.exe
...
RUN echo '{}' > /etc/runner-agent.json
